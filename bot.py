...
# FAST MODE:
# Pehle code me har new word ke liye online dictionary API call hota tha,
# jiski wajah se bot 2-3 second slow reply karta tha.
# Ab default me sirf local WORDLIST/WORDSET check hoga, isliye reply instant aayega.
# Agar kabhi online dictionary API chahiye, Railway variable me USE_DICTIONARY_API=1 kar sakte ho.
USE_DICTIONARY_API = os.getenv("USE_DICTIONARY_API", "0") == "1"
...
def is_valid_word(word: str) -> bool:
    ...
    # Default: API off for fast replies
    if not USE_DICTIONARY_API:
...
async def handle(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # Reaction ko await nahi kar rahe, warna reply slow ho sakta hai.
    async def _react_later():
        try:
    ...
    context.application.create_task(_react_later())
